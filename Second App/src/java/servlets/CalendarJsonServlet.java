...
public class CalendarJsonServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/javeeesample", "root", "");
            ResultSet rs = con.createStatement().executeQuery("SELECT `ID`, `Name`, `DateE` FROM `event`");
