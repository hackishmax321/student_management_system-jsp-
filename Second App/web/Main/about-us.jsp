<%-- 
    Document   : about-us
    Created on : Mar 23, 2019, 12:30:51 PM
    Author     : DigitalForce™
--%>
		...
		<nav id="main-nav">
			...
			<div id="main-navigate">
				<ul>
					...
					<li><a href="about-us.jsp" style="color:black; font-weight: bolder;">About Us</a></li>
		...
		<div class="main">
			...
			<div class="content">
				<div class="main-ban">
					...
					<h1>About Us</h1>
					<p>"With [], we belive every university student must get a chance to involve with industrial process and work with them to solve problems for better. As Industries, they should give chances to undergraduates to improve their skills.   "</p>

<h1 class="h1-level02">Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC</h1>
<p>
...
<h1 class="h1-level02">1914 translation by H. Rackham</h1>
<p>
...
<h1 class="h1-level02">Section 1.10.33 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC</h1>
<p>
