      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="user-contact.jsp">Contacts</a>
          </li>
        ...
        <div class="row" style="padding: 17px;">
          ...
          <div class="card-body">
              ...
              <%
                  try{
                    String sql2 = "Select COUNT(*) from "+session.getAttribute("username").toString()+"_table ";
                    ...
                    for(int i =0; i<count; i++){
                        rs = ps2.executeQuery("Select * from "+session.getAttribute("username").toString()+"_table Where ID = "+(i+1)+" AND Role = 'Admin' ");
                        if(rs.next()){
                        ...
                        <div class="user-ban" id="left-part2">
                            <br>
                            <% 
                                String sql4 = "Select UserImg from university where Username = '"+rs.getString("Username")+"' ";
                                rs2 = ps.executeQuery(sql4);
                                if(rs2.next()){
                            ...
                            <div id="right-img">
                                ...
                                <a href="chat-box.jsp?u=<%=rs.getString("Username")%>&v=<%=rs.getInt("ID")%>"  class="btn btn-success">Join Chat</a> <a href="DBjspAction/dbApproch.jsp?u="  class="btn btn-danger">Remove Contact</a>
                            </div>
                        </div>
          ...
          <div class="card-body">
              ...
              <%
                  try{
                    ...
                    for(int i =0; i<count; i++){
                        rs = ps2.executeQuery("Select * from "+session.getAttribute("username").toString()+"_table Where ID = "+(i+1)+" AND Role = 'Undergraduate' ");
                        if(rs.next()){
                        ...
                        <div class="user-ban" id="left-part2">
                            <br>
                            <% 
                                String sql4 = "Select UserImg from users2 where FirstName = '"+rs.getString("Username")+"' ";
                                rs2 = ps.executeQuery(sql4);
                                if(rs2.next()){
                                byte[] imgData = rs2.getBytes("UserImg"); // blob field 
          ...
          <div class="card-body">
              ...
              <%
                  try{
                    ...
                    for(int i =0; i<count; i++){
                        rs = ps2.executeQuery("Select * from "+session.getAttribute("username").toString()+"_table Where ID = "+(i+1)+" AND Role = 'Industry' ");
                        if(rs.next()){
                        ...
                        <div class="user-ban" id="left-part2">
                            <br>
                            <% 
                                String sql4 = "Select UserImg from industry where ChiefPerson = '"+rs.getString("Username")+"' ";
                                rs2 = ps.executeQuery(sql4);
                                if(rs2.next()){
                                byte[] imgData = rs2.getBytes("UserImg"); // blob field 
