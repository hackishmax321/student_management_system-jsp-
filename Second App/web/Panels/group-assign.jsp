      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="my-contact.jsp">Contacts</a>
          </li>
          <li class="breadcrumb-item active">Group Assign</li>
        </ol>
       ...
       <div class="row" style="padding: 17px;">
          ...
          <div class="card-header">
            ...
            Assignments / Projects</div>
          <div class="card-body">
        
        <div class="row">
            <%
                try {
                rs = ps.executeQuery("Select COUNT(*) from problem ");
                int x = 0;
                if (rs.next()){
                    x = rs.getInt(1);
                }
                for(int i = 0; i<x; i++){
                    rs = ps.executeQuery("Select * from problem where Taker = '"+session.getAttribute("username").toString()+"' AND ID = "+(i+1)+" ");
                    if(rs.next()){
                ...
                <div class="card text-white bg-dark o-hidden h-100">
                  <div class="card-body">
                    <div class="card-body-icon">
                      ...
                      <div class="mr-5"><h4><%=rs.getString(2)%></h4></div>
                      <div class="mr-5"><p><%=rs.getString(4)%></p><br>[Group Leader]</div>
                  </div>
                  <a class="card-footer text-white clearfix small z-1" href="problem-group-form.jsp?id=<%=rs.getInt(1)%>&name=<%=rs.getString(2)%>&lead=<%=rs.getString(6)%>">
                    <span class="float-left">View Group Details</span>
