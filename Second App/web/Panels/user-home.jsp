<%-- 
    Document   : home
    Created on : Mar 25, 2019, 12:13:54 AM
    Author     : DigitalForce™
--%>
...
<% 
      ...
      %>
    <a class="navbar-brand mr-1" href="index.html"><%= panelN %> Panel - Home</a>
      ...
      <div class="container-fluid">
        ...
        <div class="swiper-wrapper">
            ...
            <%
                                                                    ...
                                                                    for(int i=0;i<x;i++){
                                                                        String query2 = "";
                                                                        if((session.getAttribute("user-role")=="Industry")){
                                                                            query2 = "Select * from event where ID="+(i+1)+"";
                                                                        } else {
                                                                            query2 = "Select * from event where ID="+(i+1)+" AND (Target ='"+session.getAttribute("university").toString()+"' OR Target ='All') ";
                                                                        }
                                                                        //stmt.setInt(1, (i+1));
                                                                        //ob2.println(stmt);
          ...
          <div class="swiper-slide" >
            <div class="swiper-img" style="background-image:url('<%= request.getContextPath()%>/<%=y%>')"></div>
            <div class="swipe-des">
                    <h5><%=rs.getString(2)%><br>
                    <span><%=rs.getString(4)%></span></h5>
            </div>
          </div>
