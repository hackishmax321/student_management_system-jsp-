<%-- 
    Document   : dashboard
    Created on : Mar 29, 2019, 4:29:19 PM
    Author     : DigitalForce™
--%>
...
<% 
      ...
      %>
    <a class="navbar-brand mr-1" href="index.html"><%= panelN %> Panel - Dashboard</a>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"> Forum Threads!</div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="announcement.jsp">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
