                ...
                <table id="subT">
                    ...
                    <% 
                                ...
                                if(cookies!=null){
                                    ...
                                    <tr><td class="left"><ion-icon name="contact"></ion-icon></td><td class="right"><input type="text" name="uname" placeholder="Username" ></td></tr>
...
<%
                        ...
                        response.sendRedirect(request.getContextPath()+"/Panels/user-home.jsp");
}
                    %>
	    	</table>
	    	<div id="final">
