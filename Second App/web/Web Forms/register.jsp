	...
	<script src="https://unpkg.com/ionicons@4.4.8/dist/ionicons.js"></script>
        ...
        <script>
            ...
            function validate(){
                ...
                var uname = document.forms["regform"]["fname"];
                var fname = document.forms["regform"]["lname"];
                var mobile = document.forms["regform"]["mobile"];
                var email = document.forms["regform"]["email"];
                var uniname = document.forms["regform"]["uniname"];
                ...
                if(uniname.value===""){
                    window.alert("You need to enter Your attending university name!");
                    return false;
                }
                if(uniid.value===""){
                    window.alert("You need to enter Your university ID!");
                    return false;
                }
    ...
    <div class="login-box">
     <img src="Image/user-pink2.png" class="user"> 	
	    ...
	    <h1>REGISTRATION</h1><center>
	    	...
	    	<table id="subT">
                    <tr><td class="left"><ion-icon name="contact"></ion-icon></td><td class="right"><input type="text" name="fname" id="fname"  placeholder="Username You Desired" value="<%if(session.getAttribute("usedname")!=null){%><%=session.getAttribute("usedname")%><%}%>" style="background-color:<%if(session.getAttribute("color")!=null){%><%=session.getAttribute("color")%><%}%> ;"></td></tr>


                                    

                        <tr><td class="left"><ion-icon name="contact"></ion-icon></td><td class="right"><input type="text" name="lname"  placeholder="Full Name" value="<%if(session.getAttribute("usedfname")!=null){%><%=session.getAttribute("usedfname")%><%}%>"></td></tr>
	    		...
	    		<tr><td class="left"><ion-icon name="mail"></ion-icon></td><td class="right"><input type="text" name="email" placeholder="E-mail" value="<%if(session.getAttribute("usedemail")!=null){%><%=session.getAttribute("usedemail")%><%}%>"></td></tr>
                    ...
                    <td>
                <table id="subT">
                        <tr><td class="left"><ion-icon name="school"></ion-icon></td><td class="right"><input type="text" name="uniname"  placeholder="University Name" value="<%if(session.getAttribute("useduni")!=null){%><%=session.getAttribute("useduni")%><%}%>"></td></tr>
                        <tr><td class="left"><ion-icon name="card"></ion-icon></td><td class="right"><input type="text" name="uniid" placeholder="University ID"></td></tr>
	    		...
	    		<tr><td class="left"><ion-icon name="keypad"></ion-icon></td><td class="right"><input type="password" name="cpass"  placeholder="Confirm Password"></td></tr>
                        <tr><td class="left"><ion-icon name="close-circle"></ion-icon></td><td class="right"><input type="text"  placeholder="Nothin Available"></td></tr>
                </table>
                      </td></tr>
